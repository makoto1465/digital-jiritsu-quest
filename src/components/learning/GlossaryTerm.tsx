...
const glossary = {
  ...
  taskbar: { label: "タスクバー", definition: "Windows画面の下にある帯です。表示中のアプリアイコンをもう一度押すと最小化し、もう一度押すと元の大きさで戻せます。" },
  minimize: { label: "最小化", definition: "ウィンドウを閉じず、タスクバーへ小さくしまう操作です。右上の『―』、または表示中アプリのタスクバーアイコンを使います。" },
