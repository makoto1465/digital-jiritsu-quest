...
export const missionChallenges: Record<string, MissionChallenge> = {
  ...
  navigation: challenge(
    ...
    undefined,
    {
      windows: "Microsoft Edge を開き、施設案内から検索結果へ戻ります。",
      mac: "Dock から Safari を開き、施設案内から検索結果へ戻ります。",
      iphone: "Dock から Safari を開き、施設案内から検索結果へ戻ります。",
      android: "Chrome を開き、施設案内から検索結果へ戻ります。",
    },
    {
      windows: [["browser-opened-from-desktop"], ["page-opened"], ["went-back"]],
      mac: [["browser-opened"], ["page-opened"], ["went-back"]],
      iphone: [["browser-opened"], ["page-opened"], ["went-back"]],
      android: [["browser-opened"], ["page-opened"], ["went-back"]],
    },
  ),
  "open-close": challenge(
    ...
    undefined,
    {
      windows: "メモ帳を開き、最小化・復元・閉じるの違いを練習します。",
      mac: "テキストエディットを開き、赤いボタンで閉じてから、Dock で開き直します。",
      iphone: "メモを開き、App スイッチャーで終了してから、もう一度開きます。",
      android: "Keep メモを開き、最近使ったアプリで終了してから、もう一度開きます。",
    },
  ...
  "app-switch": challenge(
    ...
    undefined,
    {
      windows: "Microsoft Edge とメモ帳を、タスクバーで切り替えます。",
      mac: "Safari とテキストエディットを、Dock で切り替えます。",
      iphone: "Safari とメモを、ホーム画面や下のバーで切り替えます。",
      android: "Chrome と Keep メモを、最近使ったアプリで切り替えます。",
    },
    {
      windows: [["browser-opened"], ["notes-opened"], ["app-switched"], ["app-switched-twice"]],
      mac: [["browser-opened"], ["two-apps-open"], ["app-switched"]],
      iphone: [["browser-opened"], ["two-apps-open"], ["app-switched"]],
      android: [["browser-opened"], ["two-apps-open"], ["app-switched"]],
    },
  ),
  "menu-discovery": challenge(
    ...
    undefined,
    {
      windows: "Microsoft Edge の大きさと場所を変えます。",
      mac: "メニューバーの「表示」から、文字の大きさを変えます。",
      iphone: "Safari の「ぁA」から、文字の大きさを変えます。",
      android: "Chrome の「⋮」から、文字の大きさを変えます。",
    },
    {
      windows: [["browser-opened"], ["window-maximized"], ["window-restored-down"], ["window-moved"]],
      iphone: [["browser-opened"], ["menu-opened"], ["display-opened"]],
      android: [["browser-opened"], ["menu-opened"], ["display-opened"]],
    },
  ),
...
const missionStepInstructions: Record<string, StepInstructionSet> = {
  ...
  navigation: {
    default: ["『中央公民館｜施設案内』を{{activate}}してください。", "『← 戻る』を{{activate}}してください。"],
    windows: ["デスクトップ左側の『Microsoft Edge』をダブルクリックしてください。", "検索結果にある、青い文字の『中央公民館｜施設案内』を1回左クリックしてください。", "アドレス バーの左にある『←（戻る）』を1回左クリックしてください。"],
    mac: ["画面下の Dock にある『Safari』をクリックしてください。", "青い文字の『中央公民館｜施設案内』をクリックしてください。", "画面左上の『←（戻る）』をクリックしてください。"],
    iphone: ["ホーム画面いちばん下の Dock にある『Safari』をタップしてください。", "青い文字の『中央公民館｜施設案内』をタップしてください。", "画面いちばん下の『←（戻る）』をタップしてください。"],
    android: ["ホーム画面いちばん下の『Chrome』をタップしてください。", "青い文字の『中央公民館｜施設案内』をタップしてください。", "画面いちばん下の『◁（戻る）』をタップしてください。"],
  },
  "open-close": {
    ...
    mac: [
      "Dock の『テキストエディット』をクリックして開いてください。",
      "ウインドウ左上の『赤いボタン』をクリックして、ウインドウを閉じてください。",
      "Dock の『テキストエディット』をもう一度クリックしてください。（赤で閉じてもアプリは終了していません）",
    ],
    iphone: [
      "ホーム画面の『メモ』をタップして開いてください。",
      "画面いちばん下のバーを大きく上へスワイプし、App スイッチャーで『終了』をタップしてください。",
      "ホーム画面の『メモ』をもう一度タップしてください。",
    ],
    android: [
      "ホーム画面の『Keep メモ』をタップして開いてください。",
      "画面下の『□（最近使ったアプリ）』を押し、『終了』をタップしてください。",
      "ホーム画面の『Keep メモ』をもう一度タップしてください。",
    ],
  },
  "app-switch": {
    default: ["2つのアプリを開いてください。", "前に使っていたアプリへ切り替えてください。"],
    windows: [
      "タスクバーの『Microsoft Edge』を1回左クリックしてください。",
      "タスクバーの『メモ帳』を1回左クリックしてください。",
      "タスクバーの『Microsoft Edge』を1回左クリックしてください。",
      "タスクバーの『メモ帳』を1回左クリックしてください。",
    ],
    mac: ["Dock の『Safari』をクリックして開いてください。", "Dock の『テキストエディット』をクリックして開いてください。", "Dock の『Safari』をクリックして切り替えてください。"],
    iphone: ["ホーム画面の『Safari』をタップして開いてください。", "下のバーを上へスワイプしてホームへ戻り、『メモ』をタップしてください。", "下のバーを左右へスワイプするか、ホームから『Safari』をタップして切り替えてください。"],
    android: ["ホーム画面の『Chrome』をタップして開いてください。", "『○（ホーム）』を押し、『Keep メモ』をタップしてください。", "『□（最近使ったアプリ）』を押し、『Chrome』をタップして切り替えてください。"],
  },
  "menu-discovery": {
    default: ["メニューを開いてください。", "『表示』の項目を選んでください。"],
    windows: [
      "タスクバーの『Microsoft Edge』を1回左クリックしてください。",
      "右上の『□（最大化）』を1回左クリックしてください。",
      "右上の『❐（元のサイズに戻す）』を1回左クリックしてください。",
      "上部の帯（タイトルバー）を左へドラッグしてください。",
    ],
    mac: ["画面いちばん上の帯（メニューバー）の『表示』をクリックしてください。", "出てきた一覧から『拡大』をクリックしてください。"],
    iphone: ["Dock の『Safari』をタップして開いてください。", "画面下のアドレス欄の左にある『ぁA』をタップしてください。", "『Ａ』を押して文字を大きくしてください。"],
    android: ["『Chrome』をタップして開いてください。", "右上の『⋮』をタップしてください。", "『テキストのサイズ変更』をタップしてください。"],
  },
  typing: {
    default: [
